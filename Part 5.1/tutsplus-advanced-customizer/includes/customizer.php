...
/**************************************************************************
add CSS classes for layout
**************************************************************************/
function tutsplus_layout_body_classes( $classes ) {
	
	$bodyclass = get_theme_mod( 'tutsplus_layout_setting' );
	$classes[] = $bodyclass;
	return $classes;
...
/**************************************************************************
add controls for colour scheme
**************************************************************************/
function tutsplus_customize_register_colorscheme( $wp_customize ) {
	
	//add the setting for the layout
	$wp_customize->add_setting( 'tutsplus_colorscheme_setting' );
	
	//add control for layout
	$wp_customize->add_control( 'tutsplus_colorscheme_control', array(
		'label'		=> __( 'Color scheme', 'tutsplus' ),
		'section'	=> 'tutsplus_colorscheme',
		'settings'	=> 'tutsplus_colorscheme_setting',
		'type'		=> 'radio',
		'choices'	=>	array(
			'brown'		=>	'Browns',
			'blue'		=>	'Blues',
...
add_action( 'customize_register', 'tutsplus_customize_register_colorscheme' );

/**************************************************************************
add CSS classes for color scheme
**************************************************************************/
function tutsplus_color_body_classes( $classes ) {
	
	$bodyclass = get_theme_mod( 'tutsplus_colorscheme_setting' );
	$classes[] = $bodyclass;
	return $classes;
	
}
add_filter( 'body_class', 'tutsplus_color_body_classes' );